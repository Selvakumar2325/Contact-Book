...
cursor.execute(
"CREATE TABLE IF NOT EXISTS CONTACT_BOOK (S_NO INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NAME TEXT, EMAIL TEXT, PHONE_NUMBER TEXT, ADDRESS TEXT,PASSWORD TEXT,CONFIRM TEXT)"
)

# Defining the functions
##global-create variable from non-global scope
#fetch-import he module and function called kw list
def submit_record():
...
lf_bg = "#C0C0C0"  # Lightest Shade
cf_bg = "#C0C0C0"
rf_bg = "#C0C0C0"  # Darkest Shade
...
Label(root, text='CONTACT BOOK', font=("times", 15, "bold"), bg='Black', fg='White').pack(side=TOP, fill=X)
...
Label(left_frame, text='developed by Selvakumar', bg=lf_bg, font=frame_font).place(relx=0.30, rely=0.80)
